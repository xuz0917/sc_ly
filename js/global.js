...
function(a, b) {
    ...
    function e(a, b) {
        var c = {};
        return K.each(wc.concat.apply([], wc.slice(0, b)),
        function() {
            c[this] = a
        }),
        c
    ...
    function p(a, b, c) {
        ...
        if (d = Eb(a, b, b), (0 > d || null == d) && (d = a.style[b] || 0), d = parseFloat(d) || 0, c) for (; g > f; f++) d += parseFloat(K.css(a, "padding" + e[f])) || 0,
    ...
    K.event = {
        ...
        dispatch: function(c) {
            ...
            if (p[0] = c, c.delegateTarget = this, o && !c.target.disabled && (!c.button || "click" !== c.type)) for (g = K(this), g.context = this.ownerDocument || this, f = c.target; f != this; f = f.parentNode || this) {
                ...
                m = l.selector,
                i[m] === b && (i[m] = l.quick ? gb(f, l.quick) : g.is(m)),
                i[m] && k.push(l);
                k.length && r.push({
                    elem: f,
                    matches: k
    ...
    function(a, b) {
        K.fn[a] = function(c, d) {
            ...
            e = this.length > 1 && !ob[a] ? K.unique(e) : e,
            (this.length > 1 || kb.test(d)) && jb.test(a) && (e = e.reverse()),
    ...
    Cb.th = Cb.td,
    K.support.htmlSerialize || (Cb._default = [1, "div<div>", "</div>"]),
    K.fn.extend({
        text: function(a) {
    ...
    K.buildFragment = function(a, b, c) {
        ...
        1 === a.length && "string" == typeof h && h.length < 512 && g === H && "<" === h.charAt(0) && !xb.test(h) && (K.support.checkClone || !zb.test(h)) && (K.support.html5Clone || !yb.test(h)) && (e = !0, f = K.fragments[h], f && 1 !== f && (d = f)),
    ...
    function(a, b) {
        K.cssHooks[b] = {
            get: function(a, c, d) {
                var e;
                return c ? 0 !== a.offsetWidth ? p(a, b, d) : (K.swap(a, Nb,
                function() {
                    e = p(a, b, d)
                }), e) : void 0
            },
    ...
    K.support.opacity || (K.cssHooks.opacity = {
        ...
        set: function(a, b) {
            ...
            c.zoom = 1,
            b >= 1 && "" === K.trim(f.replace(Hb, "")) && (c.removeAttribute("filter"), d && !d.filter) || (c.filter = Hb.test(f) ? f.replace(Hb, e) : f + " " + e)
        }
    }),
    K(function() {
    ...
    H.defaultView && H.defaultView.getComputedStyle && (Fb = function(a, b) {
        var c, d, e;
        return b = b.replace(Jb, "-$1").toLowerCase(),
    ...
    H.documentElement.currentStyle && (Gb = function(a, b) {
        ...
        !Kb.test(f) && Lb.test(f) && (c = g.left, d = a.runtimeStyle && a.runtimeStyle.left, d && (a.runtimeStyle.left = a.currentStyle.left), g.left = "fontSize" === b ? "1em": f || 0, f = g.pixelLeft + "px", g.left = c, d && (a.runtimeStyle.left = d)),
        "" === f ? "auto": f
    }),
    Eb = Fb || Gb,
    ...
    try {
        ...
        Qb = H.createElement("a"),
        Qb.href = "",
        Qb = Qb.href
    }
    Rb = ec.exec(Qb.toLowerCase()) || [],
    K.fn.extend({
        load: function(a, c, d) {
            ...
            return K.ajax({
                ...
                complete: function(a, b, c) {
                    ...
                    a.isResolved() && (a.done(function(a) {
                        c = a
                    }), h.html(f ? K("<div>").append(c.replace(ac, "")).find(f) : c)),
                    d && h.each(d, [c, b, a])
                }
            }),
            this
    ...
    K.extend({
        ...
        ajax: function(a, c) {
            ...
            y.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + ic + "; q=0.01": "") : p.accepts["*"]);
    ...
    function(b, c, d) {
        ...
        if ("jsonp" === b.dataTypes[0] || b.jsonp !== !1 && (lc.test(b.url) || e && lc.test(b.data))) {
            ...
            j = b.data,
            k = "$1" + g + "$2";
            return b.jsonp !== !1 && (i = i.replace(lc, k), b.url === i && (e && (j = j.replace(lc, k)), b.data === j && (i += (/\?/.test(i) ? "&": "?") + b.jsonp + "=" + g))),
            b.url = i,
            b.data = j,
            a[g] = function(a) {
                f = [a]
            ...
            return {
                send: function(e, f) {
                    ...
                    d = function(a, e) {
                        var h, j, k, l, m;
                        try {
                            if (d && (e || 4 === i.readyState)) if (d = b, g && (i.onreadystatechange = K.noop, nc && delete mc[g]), e) 4 !== i.readyState && i.abort();
                            else {
                                h = i.status,
                    ...
                    c.async && 4 !== i.readyState ? (g = ++oc, nc && (mc || (mc = {},
                    K(a).unload(nc)), mc[g] = d), i.onreadystatechange = d) : d()
                },
                abort: function() {
                    d && d(0, 1)
                }
    ...
    K.fn.extend({
        ...
        animate: function(a, b, c, e) {
            function f() {
                ...
                c = a[e],
                uc.test(c) ? (l = K._data(this, "toggle" + e) || ("toggle" === c ? o ? "show": "hide": 0), l ? (K._data(this, "toggle" + e, "show" === l ? "hide": "show"), f[l]()) : f[c]()) : (h = vc.exec(c), i = f.cur(), h ? (j = parseFloat(h[2]), k = h[3] || (K.cssNumber[e] ? "": "px"), "px" !== k && (K.style(this, e, (j || 1) + k), i = (j || 1) / f.cur() * i, K.style(this, e, i + k)), h[1] && (j = ("-=" === h[1] ? -1 : 1) * j + i), f.custom(i, j, k)) : f.custom(i, c, ""));
                return ! 0
            }
            var g = K.speed(b, c, e);
    ...
    K.fx.prototype = {
        ...
        step: function(a) {
            ...
            return 1 / 0 == i.duration ? this.now = e: (c = e - this.startTime, this.state = c / i.duration, this.pos = K.easing[i.animatedProperties[this.prop]](this.state, c, 0, 1, i.duration), this.now = this.start + (this.end - this.start) * this.pos),
            this.update(),
            !0
        }
    },
    ...
    function(a) {
        ...
        k -= b.scrollTop,
        l -= b.scrollLeft,
        b === d && (k += b.offsetTop, l += b.offsetLeft, K.support.doesNotAddBorder && (!K.support.doesAddBorderForTableAndCells || !xc.test(b.nodeName)) && (k += parseFloat(c.borderTopWidth) || 0, l += parseFloat(c.borderLeftWidth) || 0), e = d, d = b.offsetParent),
...
function(a) {
    ...
    function() {
        ...
        d = function(a) {
            for (var b, c = /\[([^[]*)\]/g,
            d = /^([^[]+)(\[.*\])?$/.exec(a), e = d[1], f = []; b = c.exec(d[2]);) f.push(b[1]);
            return [e, f]
        },
        g = function(b, c, d) {
            var e = c.shift();
...
function(a, b) {
    function c(a, b) {
        ...
        for (1 == c.length && (a = d) && (e = 0); b = c[e++];) for (var g in b) ! b.hasOwnProperty(g) || !f && g in a || (a[g] = b[g]);
        return a
    }
    var d = function() {},
    e = +new Date,
    ...
    if (c({
        ...
        filter: function(a, b) {
            var c, d = 0,
            e = a.length;
            if (e) for (; e > d && !1 !== b(d, a[d]); d++);
            else for (c in a) if (!1 === b(c, a[c])) break
        },
        hash: function(a) {
            for (var b = 16777619,
            c = a.length - 1; c >= 0; c--) b ^= (b << 5) + a.charCodeAt(c) + (b >> 2);
            return 2147483647 & b
        },
        uuid: function() {
            return e++
        ...
        object: function(a, b) {
            function c() {}
            return c.prototype["@CLASSNAME"] = a,
            c.prototype = b,
            new c
        },
        procopy: function(a) {
            var b;
            if (arguments.length >= 2) for (var c = arguments.length - 1; c > 0; c--) {
                b = arguments[c];
        ...
        deferred: function(a) {
            var b = [],
            c = function(a) {
                return "function" != typeof a ? c.defer = a || "one": b.push(a),
                c
            };
            return c.defer = a || "one",
            c.fire = function(a) {
        ...
        substitute: function(a, b, c) {
            if (2 == arguments.length) return a.replace(/\{([^{}]+)\}/g,
            function(a, c) {
                var d = b[c];
                return void 0 !== d ? "" + d: ""
            });
        ...
        "#module:compiled": function(a, b) {
            ...
            h = [],
            i = 0;
            for ("string" != typeof a && (a = a.toString()), d.substitute(a.replace(/\\\n/g, "").replace(/require\s*\(\s*['"]([\w\.]+)['"]\s*\)/gm, "require(|$1|)"), f["@interface"], "").replace(/\|/g, '"').replace(f["@replace"],
            function(a, b) {
                e.push(b)
        ...
        "#module:listener": function() {
            ...
            e = 0;
            return function(f) {
                var g = this; (a = a || d["package"]["#module:cache"]) && !b[f] && ++e && (1 == e && (c = setInterval(function() {
                    for (var f in b) if (b.hasOwnProperty(f)) {
                        var h = b[f],
                        i = !0;
                        if (h.depend.length) for (var j = h.depend.length - 1; j >= 0; j--) if (!a["@factory:" + h.depend[j]]) {
                            i = !1;
                            break
                        }
        ...
        "#module:require": function(a) {
            ...
            if (d["@module:" + f] = a, b = d["@exports:" + f] || (d["@exports:" + f] = {}), c = a.depend.length) {
                ...
                if (g.minify) {
                    ...
                    g.minbase && (h += "&b=" + g.minbase),
                    g.debug && (h += "&debug"),
                    this.loadJS(h + "::" + f,
                    function() {
                        for (var b, c = a.depend,
                        e = 0; b = c[e++];) d["@loaded:" + b] = !0,
                        d["@exports:" + b] = d["@exports:" + b] || {};
                        d["@loaded:" + f] = !0
                    })
                } else for (; c > e;) this.loadJS(this["#module:truepath"](a.depend[e++]),
                function(a) {
                    d["@exports:" + a] = d["@exports:" + a] || {},
                    d["@loaded:" + a] = !0
                })
            } else d["@loaded:" + f] = !0; ! a.anonymous && this["#module:listener"](f)
        },
        ...
        define: function(a, b, c, e) {
            ...
            if ("boolean" == typeof arguments[g - 1] && (e = arguments[--g]), "undefined" == typeof c && ("function" == typeof a ? (c = a, a = d.uuid()) : ("function" == typeof b ? (c = b) && (b = a) : c = a, a = null)), "function" != typeof c) {
                ...
                if ("object" == typeof c) for (var j in c) c.hasOwnProperty(j) && (h["@data:" + j] = c[j]);
                else if (void 0 == b) return h["@data:" + c] || null
            } else null == a && (a = b) && (b = null),
            f = [] || this["#module:compiled"](c, b ? b instanceof Array ? b: b.split(d.sword) : []),
            c["#module"] = a || f.join("") || d.uuid(),
            this["#module:require"]({
                module: c["#module"],
                depend: f,
                factory: c,
        ...
        loadJS: function(a, b, c) {
            ...
            e.defer = !0,
            e.src = g[0] + (this["#module:config"].cache ? "": (g[0].indexOf("?") > -1 ? "&": "?") + "t=" + +new Date),
            e.readyState ? d.bind(e, "readystatechange",
            function() {
                f["#module:cache"]["@regr_ready"].test(e.readyState) && (b && b(g[1] || null), d.unbind(e, "readystatechange", arguments.callee))
            }) : d.bind(e, "load",
            function() {
                b && b(g[1] || null),
                d.unbind(e, "load", arguments.callee)
            }),
            d.bind(e, "error",
            function() {
                c && c(),
                d.unbind(e, "error", arguments.callee)
            }),
        ...
        mask: function() {
            ...
            return function(d, e, f) {
                ...
                if (g.length && (b = !0), !b && a.appendTo(f.body) && (b = !0), "boolean" == typeof d) a.hide(),
                g.hide();
                else {
                    var f = $(f);
                    d && a.css("z-index", d),
                    a.show(),
                    a.css("height", f.outerHeight()),
                    c++
                }
            }
        } (),
    ...
    }), d.namespace("EventEmitter",
    function() {
        var a = function() {};
        return a.prototype = {
            addListener: function(a, b, c) {
                return ! this["#eventcache"] && (this["#eventcache"] = {}),
                !this["#eventcache"][a] && (this["#eventcache"][a] = []),
                "function" == typeof b && this["#eventcache"][a].push({
                    type: a,
                    handler: b,
                    guid: b[f] = d.uuid(),
            ...
            on: function(a, b, c) {
                var d = this;
                return jQuery.isArray(a) || (a = a.split(/,\s*/)),
                jQuery.each(a,
                function(a, e) {
            ...
            removeListener: function(a, b) {
                if (b && this["#eventcache"][a]) for (var c = this["#eventcache"][a].length - 1; c >= 0; c--) this["#eventcache"][a].guid === b[f] && this["#eventcache"][a].splice(c, 1);
                else a && (this["#eventcache"][a] = [])
            },
            trigger: function(a, b, c) {
                var d, e = [];
                if (!this["#eventcache"] && (this["#eventcache"] = {}), a = this["#eventcache"][a]) for (var f = a.length - 1; f >= 0; f--) d = a[f].handler($.extend({},
                a[f].data, b)),
                e.push(d);
                return c ? e: d
            }
        ...
        a
    }), d.namespace("EventDelegate",
    function() {
        var a = function() {};
        return a.prototype = {
            bindTarget: function(a, b) {
                var c = this; ! this["@dataType"] && (this["@dataType"] = {}),
                !this["@action"] && (this["@action"] = "action-type"),
                !this["@actionType"] && (this["@actionType"] = {}),
                this["@actionType"][b = b || "click"] || a.bind(this["@actionType"][b] = b,
                function(a) {
                    c.eventDelegate(a)
                })
            },
            eventDelegate: function(a) {
                var b, c = $(a.target); (b = c.attr(this["@action"])) && this.trigger(a.type + ":" + b, this["@eventData"](c, a))
            },
            "@eventData": function(a, b) {
                ...
                if (d.length) for (; c = d[e++];) f[c[0]] = c[1];
                if (c = a.attr("action-data")) for (c = c.split("&"); e = c.pop();) 2 == (e = e.split("=")).length && (f[e[0]] = e[1]);
                return f.event = b,
                f
            },
            bindData: function(a) {
    ...
    function() {
        ...
        return a.prototype = {
            ...
            after: function(a, b) {
                ...
                this.af || (this.af = {}),
                this[a] = function() {
                    return this.af[a] = c.apply(this, arguments),
        ...
        inputEmpty: function(a) {
            this.each(function() {
                function b(b, c) {
                    var d = c.find("em"),
                    e = b;
                    a = d.attr("defalut-value") || a,
                    /^\s*$/.test(e.val()) || e.val() == a ? (d.text(a), e.val("")) : d.text("")
                }
                var c = $(this),
                d = c.find("input[type='text']");
                d = d.length ? d: c.find("textarea"),
                d.focus(function() {
                    c.find("em").text("")
                }),
                d.blur(function() {
        ...
        ie6winFloat: function(a) {
            ...
            if (b) {
                ...
                if (d.setAttribute("type", "text/css"), c.append(d), d.styleSheet) {
                    ...
                    d.styleSheet.cssText = "html{_text-overflow:ellipsis;}",
                    d.styleSheet.cssText += "#" + $(this).attr("id") + "{position:absolute;top:expression(fixed = " + e + ")}"
                }
            }
        },
        yzmtimer: function(a) {
            ...
            this.each(function() {
                var a = $(this),
                c = "";
                a.hasClass("butn-green") && (a.removeClass("butn-green"), c = "butn-green"),
...
function(a) {
    ...
    c.versions.push("1.0.6"),
    c.cache = {},
    c.LEFT_DELIMITER = c.LEFT_DELIMITER || "<%",
    c.RIGHT_DELIMITER = c.RIGHT_DELIMITER || "%>",
    c.ESCAPE = !0,
    c._encodeHTML = function(a) {
...
function() {
    ...
    function d(a) {
        ...
        decodeURIComponent(document.cookie.substring(a, b))
    }
    function e(a) {
        if (!a) return "/t4.zbjimg.com/r/p/task/48.gif";
        var b, c = "000000000" + a,
        d = c.substr(c.length - 9, 9);
        return b = "/p6.zbjimg.com/user_avat_new/" + d.substr(0, 3) + "/" + d.substr(3, 2) + "/" + d.substr(5, 2) + "/48x48_avatar_" + d.substr(7, 2) + ".jpg"
    }
    ZDK.cookie = {
        setCookie: a,
        getCookie: b,
...
function(a) {
    Storage = function() {
        ...
        function d() {
            var a;
            return window.localStorage ? a = f() : window.ActiveXObject && (a = e()),
            a
        }
        function e() {
            ...
            b().addBehavior("#default#userData"),
            {
                set: function(d, e, f) {
                    ...
                    c(k) && (k = k.getTime()),
                    i.expires = new Date(k).toUTCString();
                    try {
                        i.setAttribute(j, e),
                        i.save(j)
                    } catch(l) {
                ...
                del: function(c) {
                    ...
                    try {
                        return e.load(f),
                        d = e.getAttribute(f),
                        d ? (e.removeAttribute(f), e.expires = new Date(315532799e3).toUTCString(), e.save(f), !0) : !1
                    } catch(g) {
                        return ! 1
                    }
                }
        ...
        return {
            set: function() {
                var a = this;
                return ! a._storage && (a._storage = d()),
                a._storage.set.apply(a._storage, arguments)
            },
            get: function() {
                var a = this;
                return ! a._storage && (a._storage = d()),
                a._storage.get.apply(a._storage, arguments)
            },
            remove: function() {
                var a = this;
                return ! a._storage && (a._storage = d()),
                a._storage.del.apply(a._storage, arguments)
            },
            isSupport: function() {
    ...
    "undefined" != typeof module && module.exports ? module.exports = Storage: "function" == typeof define && define.amd ? define(Storage) : (a.ZDK = a.ZDK || {},
    ZDK.store = Storage)
} (this.window || global), ZDK.define("module.tips",
function() {
    function a(a) {
    ...
    a.prototype = {
        create: function() {
            var a = [];
            a = ['<div class="ui-tips ui-tips-pop ui-tips-' + this.icon + '">'],
            a.push('<i class="ui-tips-icon iconfont">' + this._config.iconFont[this.icon] + "</i>"),
            a.push('<div class="ui-tips-bd">' + this.content + "</div>"),
            a.push("</div>");
            var b = $(a.join(""));
            return b.appendTo(document.body),
            b
        },
    ...
    var b = $("body");
    b.delegate(".zbj-tooltip", "mouseenter",
    function() {
        ...
        if (a.attr("tool-text")) {
            ...
            h = a.attr("tool-cls") || "";
            g.length >= 1 && g.remove(),
            g = $('<div class="ui-tooltip  ui-tooltip-' + c + "  " + h + ' "><div class="ui-tooltip-arrow"></div><div class="ui-tooltip-inner">' + d + "</div></div>").css({
                opacity: 0
            }).appendTo(b); {
            ...
            case "left":
                g.css({
                    top:
                    j - g.innerHeight() / 2 + a.innerHeight() / 2,
    ...
    b.delegate(".zbj-tooltip", "mouseleave click",
    function() {
        for (var a = $(this); a.attr("tool-target");) a = $("#" + a.attr("tool-target"));
        a.attr("tool-text") && $("body").find(".ui-tooltip-" + a.attr("tool-map")).remove()
    })
}), ZDK.define("module.btnloading",
function(a, b) {
    var c = b.btnloading = function(a) {
        var b = a ? a: {};
        if (!b.obj) return ! 1;
        b.nodeName = b.obj.get(0).nodeName,
        b.txt = b.txt ? b.txt: "提交中",
        b.dynamic = "undefined" != typeof b.dynamic ? b.dynamic: !0;
    ...
    return c.reset = function(a) {
        a.attr("isloading", ""),
        a.html(a.data("oldtext")),
        a.attr("class", a.data("oldclass")),
        a.get(0).loadingtimer && clearInterval(a.get(0).loadingtimer),
        a.removeAttr("disabled")
    },
    ZDK.procopy(c, ZDK.EventEmitter)
}), ZDK.define("lang.product.signup",
function(a, b) {
    var c = {
        passsimple: "密码过于简单",
        passgood: "密码强度适中",
...
}), ZDK.define("module.passport",
function(a, b) {
    function c() {
        this.$topBarCtn = $("#J-header-logic3"),
        this.passportUrl = "https://login." + ZBJInfo.baseURI
    }
    ...
    return $.extend(c.prototype, {
        login: function(a, b) {
            ...
            this._itemDoms = {},
            this._options = $.extend(c, b),
            this._options.selected in this._CONF || (this._options = c);
            var d = this,
            e = ZDK.module.window({
                title: "登录",
            ...
            d._panel = e,
            d._callback = a,
            d._switchTo(this._options.selected),
            d._bindEvents()
        },
        quickLogin: function() {
            var a;
            return function(b, c) {
                function d(a) {
                    var b = function(a) {
                        return /^1[34586]\d{9}$/.test(a)
                    },
                    c = a.val();
                    b(c) ? g() : f()
                }
                function e() {
                    $("#j-quicklogin-mobile-wrap").removeClass("error").addClass("success").find(".help-inline").hide(),
                    $("#j-mobile-verify-btn").addClass("ui-btn-primary"),
                    $("#j-mobile-verify-btn").attr("data-active", 1)
                }
                function f(a) {
                    a = a || "请输入正确的手机号码",
                    $("#j-quicklogin-mobile-wrap").removeClass("success").addClass("error").find(".help-inline").html(a).show(),
                    $("#j-mobile-verify-btn").removeClass("ui-btn-primary"),
                    $("#j-mobile-verify-btn").removeAttr("data-active")
                }
                function g() {
                    var a = $("#j-quicklogin-mobile").val();
                    $.ajax({
                        url: l("/register/ChkUn-type-2.html?mobile=" + a),
                        dataType: "jsonp",
                        jsonp: "jsonpcallback",
                        success: function(a) {
                ...
                function h(c) {
                    ...
                    if ("" == d || "" == e) return ZDK.Tips("请输入手机和验证码", 3e3, "error"),
                    !1;
                    var f = "mobile=" + d + "&ticket=" + e;
                    n(c),
                    $.ajax({
                        url: l("/register/verify"),
                        data: f,
                        jsonp: "jsonpcallback",
                        dataType: "jsonp",
                        success: function(d) {
                ...
                function i(c) {
                    p() && (n(c), $.ajax({
                        ...
                        dataType: "jsonp",
                        success: function(d) {
                            1 == d.state ? (a.hide(), b && b()) : -2 == d.state ? document.location.href = d.url: ( - 3 == d.state ? k($("#j-quicklogin-passport-form").find(".catcha-group")) : ZDK.Tips(d.msg, 5e3, "error"), $("#catchaimg").click()),
                            o(c)
                        }
                    }))
                }
                function j(a) {
                    if (a.attr("data-active") && !a.attr("disabled")) {
                        var b = $("#j-quicklogin-mobile").val();
                        $("#j-mobile-login-btn").addClass("max-butn-green");
                        var c = "mobile=" + b + "&zbj_csrf_token=" + $("#zbj_csrf_token").val(),
                        d = q("passport");
                        if (d.isValid) {
                            if (null !== d.value) {
                                var e = $("#j-quicklogin-mobile-form").find('input[name="seed"]').val();
                                c += "&seed=" + e + "&catcha=" + d.value
                            }
                            $.ajax({
                                url: l("/register/quick?send=1"),
                                data: c,
                                jsonp: "jsonpcallback",
                                dataType: "jsonp",
                                success: function(b) {
                                    if (1 == b.state) a.yzmtimer("<i></i>重新发送"),
                                    ZDK.Tips("发送成功", 3e3, "success"),
                                    $("#zbj_csrf_token").val(b.zbj_csrf_token);
                                    else {
                                        var c = b.msg,
                                        d = $("#j-quicklogin-mobile-form").find(".catcha-group"); - 1 == b.state ? (c = "请输入图片验证码!", k(d)) : m(d),
                                        ZDK.Tips(c, 5e3, "error")
                                    }
                                }
                            })
                        }
                ...
                function m(a) {
                    ...
                    d = function() {
                        var d = b.attr("src"),
                        e = +new Date;
                        return d = (d + "").replace(/seed=(\w+)/,
                        function() {
                            return "seed=" + e
                        }),
                        b.attr("src", d),
                        a.find("input[name=catcha]").val(""),
                        c.val(e),
                        !1
                    };
                    a.find(".refimg").click(d),
                    b.click(d)
                }
                function n(a) {
                ...
                function p() {
                    return $("#j-quicklogin-name").val() && $("#j-quicklogin-pwd").val() ? q("passport").isValid: (ZDK.Tips("请输入帐号和密码", 3e3, "error"), !1)
                }
                function q(a) {
                ...
                }), a.Footer.hide(), a.Body.on("click", "#j-passport-login-btn",
                function() {
                    i($(this))
                }), a.Body.on("click", "#j-mobile-verify-btn",
                function() {
                    j($(this))
                }), a.Body.on("click", "#j-mobile-login-btn",
                function() {
                    h($(this))
                }), a.Body.on("blur", "#j-quicklogin-mobile",
                function() {
                    d($(this))
                }), void a.on("posthide",
                function() {
        ...
        refreshTopbar: function() {
            ...
            var g = this;
            $(".item-userinfo .ui-dropdown").eq(0).one("mouseover",
            function() {
                $.ajax({
                    url: "/www." + ZBJInfo.baseURI + "/main/Ajaxuserinfo-uid-" + a.id,
                    type: "post",
                    dataType: "jsonp",
                    jsonp: "jsonpcallback",
                    success: function(a) {
                        $(".nouserinfo").html(a.replace(/^\s*"/, "").replace(/"\s*$/, "")).removeClass(".nouserinfo"),
                        g.loadBalance()
                    }
                })
            })
        ...
        loadBalance: function() {
            ...
            b = "/task." + ZBJInfo.baseURI + "/api/MyBalance";
            a.length > 0 && $.ajax({
                url: b,
                type: "get",
                dataType: "jsonp",
        ...
        _initContent: function(a) {
            ...
            return this._itemDoms[a] = b,
            b
        },
        _submitLogin: function() {
            function a(a) {
                return 1 != a.state ? -2 == a.state ? document.location.href = a.url: (ZDK.Tips(a.msg, 2e3, "error"), e._refreshVerify()) : (e._panel.hide(), e.refreshTopbar(), e._callback ? e._callback(a, e._panel) : ZDK.Tips("登录成功！", 3e3, "success")),
                !1
            }
        ...
        _submitRegister: function() {
            function a(a) {
                function d(a) {
                    ...
                    d = setInterval(function() {
                        ...
                        b--,
                        0 >= b && (clearInterval(d), a.html("重新发送").attr("ajaxurl", c).css({
                            color: "#0B73BB"
                        }))
                    },
                    1e3)
            ...
            if (d.data("loading") !== !0) {
                d.data("loading", !0);
                var e = ("regcallback" + +new Date, d.attr("action")); - 1 != e.indexOf("?jsonpcallback") && (e = e.substr(0, e.indexOf("?jsonpcallback"))),
                d.attr("action", e),
                $.ajax({
                    type: "post",
                    url: e,
        ...
        _validate: function(a) {
            ...
            function(a) {
                var b = a.item.find(".help-inline");
                b.attr("data-title") || b.attr("data-title", b.html()),
                b.html(a.res)
            }).on("checksuccess",
            function(b) {
                if (!a.hasClass("j_form_login")) {
                    ...
                    if (3 == d) {
                        ...
                        f = e.find("input"),
                        g = f.val();
                        if (/^[0-9]/.test(g)) return c.changeState(f, e, "error"),
                        b.item.find(".help-inline").html("昵称不能以数字开头！"),
                        !1
                    } else if (2 == d) {
                        var h = b.item.parent(".control-group").prev(".control-group");
                        if (b.input.val() != h.find("input[type='password']").val()) return c.changeState(b.input, b.item, "error"),
                        b.item.find(".help-inline").html("两次密码必须一致！"),
                        !1
                    } else if (1 == d) {
                        var e = c.items.eq(2),
                        f = e.find("input");
            ...
            function(a) {
                var b = 0 ^ a.item.attr("data-index"); (0 == b || 2 == b) && a.item.find(".help-inline").html(d("checkloading"))
            }).on("asynError",
            function(a) {
                var b = 0 ^ a.item.attr("data-index"); (0 == b || 3 == b) && a.item.find(".help-inline").html(a.json.msg)
            }).on("asynSuccess",
            function(a) {
                var b = 0 ^ a.item.attr("data-index"); (0 == b || 3 == b) && a.item.find(".help-inline").html("")
            }).on("submitBefore",
            function() {
                return a.hasClass("j_form_login") ? b._submitLogin() : b._submitRegister(),
                !1
            })
        },
...
function(a, b) {
    ...
    c.prototype = {
        entry: function(a) {
            ...
            d = this;
            c.cache && (e[a.id] = d),
            !($.browser.msie && "6.0" == $.browser.version && !$.support.style) && (this.opche.hasIframe = !1),
            ((d.pageurl = !1) || "string" == typeof c.content) && c.content.match(/^([^<>]+|[a-z\/.\?%@&=]+)$/i) && (d.pageurl = c.content),
            c.iframe = c.iframe && d.pageurl,
            c.escClose = c.escClose && c.allowClose,
            d.pageurl && (d.jsonp = !1, b() && (d.jsonp = !0)),
            d.init(this)
        },
        init: function(a) {
            if (a.create(), a.Wrap = a.Wrap || a.Window, a.bindTarget(a.Window), a.pageurl) {
                if (a.opche.iframe) return a.bindIframe();
                a.on("click:wtaid-reasyn",
                function() {
                    a.Body.html('<p class="ui-initwait">正在重新连</a>'),
                    a.pageurl += (a.pageurl.indexOf("?") > -1 ? "&": "?") + "t=" + ZDK.uuid(),
                    a.asyn()
                }),
                a.asyn()
            ...
            a.show(),
            a._inited(a),
            a.opche.onInited && a.opche.onInited(a),
            a.Wrap.css("z-index", a.opche.zIndex)
        },
        _inited: function(a, b, c) { (c = a.opche.width) && a.resetWidth(c),
            (c = a.opche.height) && "auto" != c && a.resetHeight(c),
            a.inited && a.inited(),
            a.bind && a.bind(),
            a.trigger("inited", $.extend({
                target: b || null
            })),
            a.reset && a.reset(),
            a.ready = !0,
            a.opche.isWindow || a.Window.mousedown(function(a) {
                a.stopPropagation()
            }),
        ...
        asyn: function() {
            function a(a) {
                ...
                return a = a.replace(/window\.location\.href\s?=\s?json\.msg;/, b),
                b = " if(window.healthBtnClicked) {								$(window).trigger('operationok');							}							$('.task_content').html(json.msg.content);							",
                a = a.replace(/\$\('\.task_content'\)\.html\(json\.msg\.content\);/, b),
                b = " if(window.healthBtnClicked) {								$(window).trigger('operationok');							}							$('#invite-num').html('('+json.num+')');							",
                a = a.replace(/\$\('#invite-num'\)\.html\('\('\+json\.num\+'\)'\);/, b)
            }
            var b = this,
            c = {
                type: "post",
                ...
                error: function(a, c, d) {
                    ...
                    "timeout" == c ? (d = "服务器连接超时", a = "ui-warning") : (d = "服务器连接错误", a = "ui-error"),
                    b.Body.html('<p class="ui-warning">' + d + ',请<a href="javascript:;" action-type="wtaid-reasyn">重试</a>!</p>'),
                    !1
                },
                success: function(c) {
                    ...
                    if (0 === e.indexOf("{")) {
                        ...
                        if (1 != g.state) return b.hide(),
                        ZDK.Tips(g.msg, 2e3, "warning");
                        e = g.msg
                    }
                    b.Body[0].innerHTML = e.replace(d,
                    function(b, c, d) {
                        return "text/tpl" !== c ? (d = a(d), f.push(d), "") : d
                    }),
                    b.script(f.length ? f.join(";") : ""),
                    b._inited(b)
                }
            };
            b.show(),
            b.jsonp && (c.type = "jsonp"),
            b.jsonp && (c.type = "jsonp", c.url = b.pageurl.indexOf("jsonpcallback") <= 0 ? b.pageurl + (b.pageurl.indexOf("?") > -1 ? "&": "?") + "jsonpcallback=?": b.pageurl),
            b.opche.contentType && "img" == b.opche.contentType ? $('<img style="padding:10px"/>').on("load",
            function() {
                b.opche.maxWidth && $(this).css("maxWidth", b.opche.maxWidth),
                b.opche.maxHeight && $(this).css("maxHeight", b.opche.maxHeight),
                b.Body.empty().append($(this));
                var a = /MSIE 6/i.test(navigator.userAgent);
                a && b.opche.maxWidth && this.width > b.opche.maxWidth && $(this).css("width", b.opche.maxWidth),
                b.resetWidth($(this).width() + 22),
                b._inited(b)
            }).on("error",
            function() {
                b.trigger("asynerror", {
        ...
        show: function() {
            ...
            0),
            a.opche.mask && ZDK.mask(a.opche.doc),
            a.opche.version2 && $("html", a.opche.doc).addClass("ui-noscroll")
        },
        hide: function() {
            this.target && "thinks" == this.target.attr("act-type") && this.target.parents(".user-red").removeAttr("style"),
            this.isshow && (this.isshow = !1, !1 !== this.trigger("hidebefore", {
                target: this
        ...
        bindIframe: function() {
            ...
            b = a.pageurl,
            c = a.opche;
            return a.Iframe = $('<iframe style="display:none;width:100%;border:none;" frameborder="0" scrolling="no" src="' + b + '"  ></iframe>'),
            a.Iframe.bind("load",
            function(b) {
                a.Iframe.show(),
                a.Iframe.css("height", "auto" !== c.height ? c.height || 350 : 350),
                a.Body.html("").append(a.Iframe),
                a.trigger("iframeonload", {
                    iframe: a.Iframe
                }),
                a.ready = !0,
                a.bind && a.bind(),
                (b = a.opche.width) && a.resetWidth(b),
                (b = a.opche.height) && "auto" != b && a.resetHeight(b),
                a._inited(a)
            }),
...
function(require, exports) {
    ...
    return Verify.prototype = {
        ...
        bind: function() {
            ...
            this.button.unbind("click").bind("click",
            function() {
                return a.target.submit(),
                !1
            }),
        ...
        bindItem: function(a, b, c) {
            ...
            a.focus(function() {
                d.ifocus && d.changeState(a, b, "focus"),
                i && Verify.fn.focustips(a, b, i, c, !0),
                d.trigger("itemfocus", {
                    input: a,
                    item: b
                })
            ...
            h && Verify.fn.placeholder(a, b, h, d),
            g && Verify.fn.autofocus(b)
        },
        asyn: function(a, b, c, d, e, f) {
            var g, h, i = this,
            j = d + "=" + (g = a.val()),
            k = ZDK.hash(c);
            return ! f && (i.asynCache[k + g] || i.asynCache[k]),
            !f && i.asyning ? (i.asynCache[k] = !0) && i.asynQueue.push([a, b, c, d, e]) : (i.trigger("asyning", {
                input: a,
                item: b,
                asyn: c,
                jsonp: e
        ...
        asynCallback: function(a, b, c, d, e, f) {
            var g, h = this; (g = h.asynQueue.pop()) && g.push(!0) ? h.asyn.apply(h, g) : h.asyning = !1;
            var i = ZDK.hash(d);
            h.iasyn && h.changeState(b, c, "asyning", !0),
            h.asynCache[i] = !1,
            1 == a.state ? (h.asynCache[i + f] = !0, 0 != h.trigger("asynSuccess", {
                json: a,
                input: b,
                item: c,
                name: e,
        ...
        checkItem: function(a, b, c) {
            ...
            h = this,
            i = !0;
            "checkbox" == a.attr("type") && (g = a.attr("checked")),
            h.result[c] = !1;
            for (var j in Verify.property) if (void 0 !== (d = b.attr(j)) && d && "string" == typeof(e = Verify.property[j](d, g, b))) {
                i = !1,
                e = b.attr(d + "tips") || e;
                break
            }
            ...
            if (h.isubmit && !1 === h.asynResult[c] && (e = h.asynError[c], i = !1), e = i ? h.asynSuccess[c] || e: e, 0 == i) {
                if (!b.attr("noblur") && "pop" != this.opche.alertType) {
                    ...
                    try {
                        ...
                        l.get(0).defText && l.html(l.get(0).defText),
                        b.attr("notype") && l.html(e)
                    } catch(m) {}
                }
                return h.isubmit && "text" != this.opche.alertType && Verify.fn.errortips && Verify.fn.errortips(a, b, h.errorTips.push(e) && e, c, !1, this),
                i
            }
            ...
            if (!b.attr("noblur") && "pop" != this.opche.alertType) {
                h.isuccess && h.changeState(a, b, "success"),
                h.changeState(a, b, "error", !0);
                try {
                    var l = b.find(".help-inline");
                    l.get(0).defText || (l.get(0).defText = l.html()),
                    l.html("")
                } catch(m) {}
            }
            return h.result[c] = !0
        ...
        changeState: function(a, b, c, d, e) {
            ...
            return g && (b[d ? "removeClass": "addClass"](g), a[d ? "removeClass": "addClass"](g)),
            arguments.callee
        },
        submit: function() {
    ...
    Verify.tips = function() {
        ...
        return function(c, e, f, g, h, i) {
            ...
            return j[b] && j[b].hide(),
            3 == arguments.length ? j[g] && j[g].hide() : (a = ZDK.module.poptip({
                target: c,
            ...
            function(a) {
                var b = a.target;
                b.resetWidth(50 + 16 * b.opche.datatitle.length),
                b.resetBody('<p class="ui-warning-min">' + b.opche.datatitle + "</p>"),
                b.reset(),
                !b.opche.datafocus && d(b)
...
}), ZDK.define("module.window",
function(a, b) {
    var c = a("module.wtaid").wtaid,
    d = b.window = function(a) {
        return a.zIndex = a.zIndex || 500,
        a.isWindow = !0,
        c.callee(this, arguments.callee, a)
    };
    d.prototype = {
        create: function() {
            d.create(this)
        ...
        bind: function() {
            var a = this;
            a.opche.escClose && $(a.opche.doc).bind("keyup",
            function(b) {
                27 == b.which && a.hide()
            })
        },
        reset: function() {
            this.resetPosition(),
            this.show(),
            this.opche.hasIframe && this.Window.find("iframe.ui-pop-bgd").css({
        ...
        setTitle: function(a) {
            return this.Title.html(a),
            this
        },
        setContent: function(a) {
            return this.Body.html(a),
            this.resetPosition(),
            this
        },
        setContentNode: function(a) {
            return this.Body.empty().append(a),
            this.resetPosition(),
            this
        },
        hideClose: function() {
        ...
        resetOkButton: function(a) {
            this.Footer.show(),
            this.Footer.find(".ui-window-ok").html(a)
        },
        resetCancelButton: function(a) {
            this.Footer.show(),
            this.Footer.find(".ui-window-cancel").html(a)
        },
        ok: function() {
    ...
    d.create = function(a) {
        ...
        if (b = ['<div class="ui-pop ' + c.theme + '">'], a.opche.hasIframe && b.push('<iframe scrolling="no" class="ui-pop-bgd" ' + (c.height && "auto" != c.height ? 'style="height:' + c.height + 'px"': "") + "></iframe>"), b.push('<div class="ui-pop-header">'), b.push('<a href="javascript:;" class="ui-pop-close" action-type="pop-close" ' + (c.allowClose ? "": 'style="display:none;"') + ">×</a>"), b.push("<h3>" + c.title + '</h3></div><div class="ui-pop-body"><p class="ui-initwait"> 正在加载中...</p></div>'), c.ok || c.cancel) {
            ...
            c.footer ? d += c.footer: (c.cancel && (d += '<button class="ui-btn ui-window-cancel" action-type="pop-cancel">' + ("string" == typeof c.cancel ? c.cancel: "取消") + "</button>"), c.ok && (d += '<button class="ui-btn ui-btn-inverse ui-window-ok" action-type="pop-ok">' + ("string" == typeof c.ok ? c.ok: "确定") + "</button>")),
            b.push(d + "</div>")
        } else b.push('<div class="ui-pop-footer" style="display:none;"></div>');
        b.push("</div>"),
        a.Window = $(b.join("")).appendTo(a.opche.doc.body),
        a.opche.version2 && (a.Wrap = $('<div class="ui-window2-wrap"></div>'), a.Wrap.append(a.Window), a.Wrap.appendTo(a.opche.doc.body)),
        a.Header = a.Window.find(".ui-pop-header"),
        a.Title = a.Header.find("h3"),
        a.Body = a.Window.find(".ui-pop-body"),
        a.Footer = a.Window.find(".ui-pop-footer"),
        a.Close = a.Window.find(".ui-pop-close"),
        d && (a.Ok = a.Footer.find(".ui-window-ok"), a.Cancel = a.Footer.find(".ui-window-cancel")),
        a.on("click:pop-cancel",
        function() {
            a.cancel()
        }).on("click:pop-ok",
        function() {
...
function(a, b) {
    ...
    return c.prototype = {
        init: function() {
            var a = this;
            return $(document.body).click(function(b, c) { (c = b.target.getAttribute("act-type")) ? a.click(b, c) : (c = b.target.parentNode.getAttribute("act-type")) && $(b.target.parentNode).click()
            }),
            this
        },
        click: function(a, b) {
            ...
            f[b] || (f[b] = {}),
            f[b][h] || (f[b][h] = {}),
            f[b][h].call || (f[b][h].call = g.attr("act-call")),
            f[b][h].data || (f[b][h].data = this.makeData(g.attr("act-data"))),
            c.ETarget = g,
            c.aurl = g.attr("act-href") || g.attr("data-href"),
            c.event = a,
            $.extend(c, f[b][h].data),
            this.trigger("page:" + b, c)
        },
        makeData: function(a) {
            var b = {};
            if (a) for (var c, d = a.split("&"), e = 0; c = d[e++];) {
                var f = c.split("=");
                b[f[0]] = f[1]
            }
            return b
        ...
        clearData: function(a) {
            ...
            c = {};
            if (a) for (var d in a) d in b || (c[d] = a[d]);
            return c
        },
        AJAX: function(a, b, c, d) {
            ...
            f ? (a += (a.indexOf("?") > -1 ? "&": "?") + (e = this.getData(b)) + (e ? "&": "") + "jsonpcallback=?", g.dataType = "jsonp", g.jsonp = "jsonpcallback") : g.dataType = "json",
            g.url = a,
            b = this.clearData(b),
            g.data = b,
            $.ajax(g)
...
function(a, b) {
    ...
    return d.prototype = {
        ...
        reset: function() {
            ...
            d.left = c.left,
            d.top = c.top + f + 15,
            b.opche.autoreset && (c.top < h + $(b.opche.doc.body).scrollTop() + 30 ? (b.Window.addClass("ui-poptip-bottom").removeClass("ui-poptip-top"), a = !0) : b.Window.hasClass("ui-verify-tips") || b.Window.addClass("ui-poptip-top").removeClass("ui-poptip-bottom")),
            b.opche.right || i - d.left < g ? (d.left = c.left + e - g, b.Arrow.css({
                left: "auto",
            ...
            !a && b.opche.bottom && (d.top = c.top - 15 - h),
            b.Window.hasClass("ui-verify-tips") && (d.top -= 10),
            this.Window.css({
    ...
    d.create = function(a) {
        var b, c = a.opche;
        c.bottom && (c.theme += " ui-poptip-top"),
        b += '<div class="ui-poptip ' + c.theme + '"><div class="ui-poptip-arrow"><i></i></div><div class="ui-poptip-bd"><p>  正在加载中... </p></div></div>',
        a.Window = $(b).appendTo(a.opche.doc.body),
        a.Body = a.Window.find(".ui-poptip-bd"),
        a.Arrow = a.Window.find(".ui-poptip-arrow"),
        c.right && a.Arrow.css({
            left: "auto",
            right: 20
        })
...
function(a) {
    function b(a, b) {
        ...
        function() {
            g.get(0).clickMark = 0,
            g.get(0).clickMark = ZDK.module.window({
                version2: b,
        ...
        function() { - 1 == json.state ? ZDK.Tips(json.msg, 3e3, "error") : -2 == json.state && bindMobile(),
            $(c.target).get(0).clickMark = 0
        }),
        c.preventDefault()
    }
    ...
    function d(a, b, c, d, e, f, g, h, i) {
        function j(a, b) {
            ...
            d = b.attr("del-val"); - 1 != c.val().indexOf("," + d) && (d = "," + d),
            c.val(c.val().replace(d, ""))
        }
        var k = a || $("#make-tender"),
        l = b || $("#make-filelist"),
        m = {},
        ...
        function(a) {
            if (!m[a.progress]) {
                ...
                "mp3" == b || "wav" == b || "wma" == b || "ogg" == b ? (c.addClass("upload-type-music"), c.prependTo(l)) : c.appendTo(l),
                m[a.progress] = c
            }
            window.console && console.log("up_start", a),
            n = !1
        }).on("onprogresing",
        function(a) {
            var b = m[a.progress],
            c = (a.uploaded / a.total * 100).toFixed(2) + "%";
            b.find("p.fl").html("上传" + c),
            b.find("p.adifile span").css("width", c),
            n = !1
        }).on("onprogresed",
        function(a) {
            var b = m[a.progress];
            b.find("p.fl").html("上传成功!"),
            b.find("p.adifile span").css("width", "100%"),
            b.find("div").hide(),
            b.addClass("tsuc"),
            b.find("p.file a").show().attr("del-val", a.url),
            window.console && console.log("up end", a);
            var c = e || k.find("input[name='files']");
            c.val(c.val().length ? c.val() + "-," + a.url: a.url),
            n = !0
        }).on("onprogresreadqueue",
        function(a) {
            if (!m[a.progress]) {
        ...
        function(a, b) { (b = m[a.progress]) && b.find("p.fl").html("上传失败").css("color", "red"),
            n = !1
        }).on("oncancelupload",
        function() {}),
        l.delegate("a", "click",
        ...
        return q.delegate("form .make-button .butn", "click",
        function() {
            var a = $(this);
            return n ? (ZDK.module.btnloading({
                ...
                success: function(b) {
                    if (ZDK.module.btnloading.reset(a), 1 == b.state) {
                        ...
                        c.find(".js-alert").length > 0 ? $(b.msg).insertBefore(c.find(".js-alert").eq(0)) : (q.next(".not").remove(), $('<div class="user-comet user-tobiao">' + b.msg + "</div>").insertAfter(q)),
                        ZDK.Tips("投标成功！", 3e3, "success"),
                        q.find("form").find("textarea").val(""),
                        q.find("input[type='checkbox']").removeAttr("checked"),
                        q.find("#make-filelist").find("li").each(function() {
                            j($(this)),
                            o.refreshNum()
                        }),
                        q.find("input[name='files']").val("");
                        var d = $("#j-wbaccount");
                        d.length > 0 && (d.html('<option value="0">请选择转发帐号</option><option>读取帐号中...</option>'), $("#j-wbaddr").val("").keyup()),
                        $("#werkNum").html(parseInt($("#werkNum").html()) + 1),
                        n = 1
                    } else ZDK.Tips(b.msg, 3e3, "error"),
                    $("#catchaimg").length && catchasrc("catchaimg", "catcha_seed")
                }
        ...
        k.find("textarea").focus(function() {
            ...
            k.find("textarea").val() || $(".bid-notice").show(),
            k.css({
    ...
    function(a) {
        ...
        $.ajax({
            ...
            success: function(g) {
                            ...
                            if (1 == a.state) {
                                if (e = 1, a.field) {
                                    ...
                                    case "textarea":
                                        ...
                                        break;
                                    case "input":
                                        "url" == m ? g = "url": "o_wid" == m && (g = "int"),
                                        k += '<p class="mt15 gray3">' + a.field[m][2] + '</p><div class="controls mt10" style="float:none;margin-left:0px"><input  name=' + m + ' type="text"/><em>' + a.field[m][1] + "</em></div>";
                                        break;
                                    case "file":
                                    ...
                                    k += "</div>",
                                    b ? (l += k, i()) : $("#inserHtml").length ? $("#inserHtml").html(k) : $(k).appendTo($("#report-field")),
                                    $("#reportCont").length && $("#reportCont").keyup(function() {
                                        var a = $(this).val().length;
                                        $("#reportNum").html(a),
                                        a > 500 && ZDK.Tips("举报内容不能超过500字！", 3e3, "error")
                                    }),
                                    $("#inserHtml").find("select").change(function() {
                                        var b, c = $(this);
                                        if (2 == c.val()) if ("分配赏金" == c.find("option:selected").data("name")) {
                                            var d = "";
                                            j && (d = '<br/><span class="orange">支付完成时，将扣除支付金额的' + j + "%作为平台服务费</span>"),
                                            b = '<span class="ml10">支付我<input type="text" name="amount" value="0" style="padding: 3px; vertical-align: middle; border: 1px solid #cccccc; width: 50px; height: 20px; margin:-5px 5px;" />元，退还TA <em id="moeny" class="orange">' + h + "</em> 元" + d + "</span>"
                                        ...
                                        c.next("span").length ? c.next("span").remove() : "",
                                        $(b).insertAfter(c),
                                        10 == a.mode && 2 == $(this).val() ? (0 == $("#inserHtml p.bigaoTips").length && $("#inserHtml").append('<p class="bigaoTips" class="orange"></p>'), $("#inserHtml p.bigaoTips").html("提示：退款成功时，所退还金额将扣除20%作为平台服务费")) : $("#inserHtml p.bigaoTips").html(""),
                                        $("#inserHtml").find("input[type='text']").live("keyup",
                                        function() {
                                    ...
                                    $("#inserHtml").find("input[type='checkbox']").click(function() {
                                        var a, b = $(this);
                                        a = b.checked ? '<span class="ml10">赔付我<input type="text" name="amount" value="0" style="padding: 3px; vertical-align: middle; border: 1px solid #cccccc; width: 50px; height: 20px; margin:-5px 5px;" />元，最高赔付金额<em id="moeny" class="orange">' + h + "</em> 元</span>": "",
                                        b.next("span").length ? b.next("span").remove() : "",
                                        $(a).insertAfter(b),
                                        $("#inserHtml").find("input[type='text']").live("keyup",
                                        function() {
                ...
                function i() {
                    var a = c("举报", '<div class="report-box"><form id="report-field">' + l + "</form></div>", 550,
                    function() {
                        if (0 == e) return ! 1;
                        if ( - 1 == e) return ZDK.Tips("请选择举报类型！", 3e3, "error"),
                        !1;
                        if ($("#reportCont").length && $("#reportCont").val().length > 500) return ZDK.Tips("举报内容不能超过500字！", 3e3, "error"),
                        !1;
                        var b = $("#report-field"),
                    ...
                    return b.delegate("input[type='radio']", "click",
                    function() {
                        h($(this))
                    }),
                    b.delegate("textarea", "focus",
                    function() {
                        $(this).next("em").hide()
                    }),
                    b.delegate("em", "click",
                    ...
                    b.delegate("textarea", "blur",
                    function() { / ^\s * $ / .test($(this).val()) ? ($(this).next("em").show(), $(this).css({
                ...
                if (1 == g.state) {
                    var j = g.complex ? '<br/>分歧可能来自沟通不畅，建议您与对方积极沟通。若发起的举报处理完成后产生退款，将会对您在列表中的排名产生影响！<a href="/quanzi.zhubajie.com/main/topic-qid-10458-tid-154929" target="_blank">查看详情</a>': "",
                    k = '<div class="alert mb10">为了防止恶意举报，发起举报，需冻结五分信用度作为担保，举报处理完成后将根据<a href="/chengxin.zhubajie.com/report/rule-g-2324" target="_blank">《猪八戒网举报处理制度（试行）》</a>进行相应释放。' + j + '</div><p class="gray3">您要举报的是 ' + g.user + (g.cata ? " 的" + g.cata: "") + '：</p><dl class="mt10 clearfix"><dt><a href=""><img border="0" width="48" height="48" onerror="this.onerror=null;this.src=\'/t4.zbjimg.com/r/p/task/120.gif\'" class="touxiangall" src="' + g.img + '" id="avatar"></a></dt><dd class="mt5" style="height:43px;overflow: hidden;">' + g.text + "</dd></dl>",
                    ...
                    if (g.bidworks && g.bidworks.length > 0) {
                        ...
                        for (var m = 0,
                        n = g.bidworks.length; n > m; m++) l += '<option value="' + g.bidworks[m].works_id + '">' + g.bidworks[m].works_id + "</option>";
                        l += "</select>"
                    }
                    l += '<p class="mt15 gray3" style="' + (g.me ? "display:none": "") + '">请选择举报类型：</p><p class="mt10 gray9" style="' + (g.me ? "display:none": "") + '">';
                    for (var m in g.data) for (var o in g.data[m]) {
                        var p = "";
                ...
                } else - 2 == g.state ? ZDK.Error("系统提示", g.msg, 0,
                function() {
                    return ! 0
                },
...
function(a) {
    function b(a, d, e, f) {
        ...
        if ((o.indexOf("取消") > -1 || o.indexOf("已") > -1) && (a.c = 1), -1 != o.indexOf("取消收藏")) {
            ...
            ZDK.module.poptip({
                ...
                onInited: function(b) {
                    ...
                    d.click(function() {
                        $(this).hasClass("min-butn-orange") ? c.AJAX(k, a,
                        function() {
                            i.html("收藏").removeAttr("style"),
                            1 == s ? i.next("u").removeAttr("style") : 2 == s ? i.parent("span").removeAttr("style") : i.prev(".cutline").removeAttr("style"),
                            ZDK.Tips("取消收藏成功！", 3e3, "success"),
                            b.hide()
        ...
        i.html("<i></i>请求中..."),
        "2" == i.attr("act-style") && i.removeClass("small-butn-green"),
        c.AJAX(k, a,
        function(a) {
            if ("draftdel" != e) {
                if ("draftpub" == e) if (1 == a.state) {
...
function() {
    ...
    c = "uc" + +new Date,
    d = null;
    $("a.user-card, img.user-card").live("mouseenter",
    function(e, f) {
        if (!f) {
        ...
        var m = ZDK.module.poptip({
            ...
            onContentLoaded: function() {
                try {
                    ...
                    WebIM.watchUsers([i.replace("uid=", "")])
                } catch(a) {}
            },
            onInited: function(c) {
                var d = c.opche.exo;
    ...
    function(e) {
        var f = $(e.target);
        clearTimeout(d),
        f.hasClass("user-card") || (f = f.closest(".user-card"));
        var g = f[0][c] || 0; !
        function(c) {
            setTimeout(function() { ! b[c] && a[c] && a[c].hide()
            },
            200)
        } (g)
    })
...
function(a, b, c, d) {
    ...
    a.fn.lazyload = function(c) {
        function f() {
            ...
            h.each(function() {
                var c = a(this);
                if (!i.skip_invisible || c.is(":visible")) if (a.abovethetop(this, i) || a.leftofbegin(this, i));
        ...
        return c && (d !== c.failurelimit && (c.failure_limit = c.failurelimit, delete c.failurelimit), d !== c.effectspeed && (c.effect_speed = c.effectspeed, delete c.effectspeed), a.extend(i, c)),
        g = i.container === d || i.container === b ? e: a(i.container),
        0 === i.event.indexOf("scroll") && g.bind(i.event,
        function() {
            return f()
        }),
        this.each(function() {
            ...
            function() {
                if (!this.loaded) {
                    ...
                    a("<img />").bind("load",
                    function() {
                        c.hide().attr("src", c.data(i.data_attribute))[i.effect](i.effect_speed),
                        b.loaded = !0;
                        var d = a.grep(h,
                        function(a) {
                            return ! a.loaded
                    ...
                    function() {
                        c.attr("src", "/t5.zbjimg.com/r/page/zbjimg.gif")
                    }).attr("src", c.data(i.data_attribute))
                }
            }),
            0 !== i.event.indexOf("scroll") && c.bind(i.event,
            function() {
...
function() {
    ...
    var b;
    if ("undefined" != typeof seajs && (define("hack$", [],
    function() {
        return window.$
